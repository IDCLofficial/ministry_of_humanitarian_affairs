...
export default function AboutSection({title, subtitle, image1, image2}: AboutSectionProps) {
  return (
    <section className={`relative w-full p-4 md:px-4 py-12 md:py-20 bg-[url('/images/gradient.png')] bg-no-repeat bg-cover shadow-lg overflow-hidden`}>
      <div className="flex flex-col gap-8 items-left w-full lg:w-[95%] mx-auto">
        {/* Left: Text Content */}
        <div className="flex flex-col lg:flex-row h-full justify-between w-full gap-6 md:gap-4">
            <PageTransition type="fadeUp">
              <div className="flex flex-col gap-2 w-full lg:w-auto">
                  ...
                  <h2 className="text-2xl md:text-3xl lg:text-[43px] font-bold text-white leading-tight py-4">
                      ...
                      <span className="text-green-400"> Humanitarian Affairs</span>
                  </h2>
              </div>
              <div className="relative rounded-lg overflow-hidden w-full lg:w-[70%] h-[250px] md:h-[450px] lg:h-[350px] lg:hidden">
                <Image src={image1} alt="Mandate 1" fill className="object-fit" />
              </div>
            </PageTransition>
            <div className="w-full md:w-auto flex flex-col gap-4">
              <PageTransition type="fadeUp">
                <p className="text-gray-200 text-[1rem] lg:max-w-lg text-justify text-lg">
                    {subtitle}
                </p>
              </PageTransition>
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8 w-full justify-center">
          <div className="relative rounded-lg overflow-hidden w-full lg:w-[65%] h-[180px] md:h-[350px] max-lg:hidden">
            <Image src={image1} alt="Mandate 1" fill className="object-fit" />
          </div>
          <div className="relative rounded-lg overflow-hidden w-full lg:w-[30%] h-[250px] md:h-[450px] lg:h-[350px] flex items-center justify-center">
