...
const MediaGalleryCard: React.FC<MediaGalleryCardProps> = ({ image, title, isVideo, onClick }) => {
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden flex flex-col cursor-pointer transition hover:shadow-md" onClick={onClick}>
