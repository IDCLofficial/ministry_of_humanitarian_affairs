...
const ContactInfoSection = () => (
  <div className="mb-8 md:mb-0">
    <p className="mb-4 text-[#151A21] text-[1rem]">We welcome your questions, suggestions, or partnership inquiries related to humanitarian support, social interventions, or disaster response in Imo State</p>
